import { Paper, Text, Group, Avatar, Input, Divider, Button, Flex, Modal, Radio, RadioGroup } from '@mantine/core';
...
export default function PaymentInfo({ isOpen, onClose }: PaymentInfoModalProps) {
    ...
    const handlePayment = () => {
        if (selectedPaymentMethod) {
            ...
            //console.log("Vui lòng chọn phương thức thanh toán trước khi tiến hành thanh toán.");
        }
    };
                ...
                <Modal.Body>
                    <div className='flex bg-slate-300 p-4 rounded-xl mb-5'>
                        ...
                        <div className="flex-1 flex flex-col">
                            <Text fw={600}>100.000VND</Text>
                            <Text>30 ngày</Text>
                        </div>
                    </div>

                    <Text pb={5}>Nội dung: Mua gói và khởi tạo phòng khám mới</Text>
                    ...
                    <Group>
                        <Paper
                            style={{
                                ...
                                width: '40%',
                                cursor: 'pointer',
                                color: selectedPaymentMethod === 'zalopay' ? 'blue' : 'gray',
                                border: `1px solid ${selectedPaymentMethod === 'zalopay' ? 'blue' : 'gray'}`,
                                padding: '20px',
                            }}
                        ...
                        <Paper
                            style={{
                                ...
                                width: '40%',
                                cursor: 'pointer',
                                color: selectedPaymentMethod === 'vnpay' ? 'blue' : 'gray',
                                border: `1px solid ${selectedPaymentMethod === 'vnpay' ? 'blue' : 'gray'}`,
                                padding: '20px', 
                            }}
